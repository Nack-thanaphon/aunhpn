...
<div class="container">
    <div class="row p-0">
        ...
        <div class="col-md-9  mt-3">
            ...
            <h1 class="pb-3">Newsletter</h1>
            <div class="newsletter">
                <div class="row">
                    <div class="col-sm-4 p-4 mt-2">
                        <div class="card text-dark mb-3 text-center">
                            <div class="card-header text-white bg-primary ">NOVEMBER</div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-4 p-4 mt-2">
                        <div class="card text-dark mb-3 text-center">
                            <div class="card-header text-white bg-primary ">DECEMBER</div>
                            <div class="card-body">
                                <h5 class="card-title">2022</h5>
                                <p class="card-text ">
                                    Newsletter #2
                    ...
                    <div class="col-sm-4 p-4 mt-2">
                        <div class="card text-dark mb-3 text-center">
                            <div class="card-header text-white bg-primary ">JANUARY</div>
                            <div class="card-body">
                                <h5 class="card-title">2022</h5>
                                <p class="card-text ">
                                    Newsletter #3
