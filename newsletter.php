...
<div class="row m-0 p-0">
    <div class="col-12 bg-primary py-5 text-center text-white">
        <div class="py-2">
            ...
            <small >Newsletter : Asean University Health Promotion Network</small>
            <hr>
        </div>
        ...
        $.ajax({
            ...
            for (var i = 0; i < data.length; i++) {
                tableData.push([
                    ...
                    `${data[i].month}`,
                    `
                <a href="https://www.info-aun-hpn.com/bos/uploads/newsletter/${data[i].file}" target="blank" class=" btn btn-success "><small class="m-0 p-0 font-weight-bold ">
